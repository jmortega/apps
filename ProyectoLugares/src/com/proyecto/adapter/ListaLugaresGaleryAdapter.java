 ...
 */
public class ListaLugaresGaleryAdapter extends ArrayAdapter<LugarEntity> {
	 ...
	 */
	public ListaLugaresGaleryAdapter(Context context,int textViewResourceId, ArrayList<LugarEntity> lugares) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		File file = null;
		if (convertView == null) {
		    convertView = mInflater.inflate(R.layout.lugares_item_gallery, null);
