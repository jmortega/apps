...
Ext.define('RSS.controller.Feeds', {
    ...
    showFeedConfig: function(){
        ...
        this.getToolbarFeedConfig().setTitle('Nuevo feed');
    ...
    info: function(button, e, options) {
        var sheet = Ext.getCmp('InfoSheet');
        if(!Ext.isDefined(sheet)) {
            sheet = Ext.create('RSS.view.InfoSheet');
    ...
    editFeed: function(feed){
         ...
         * by the application so it can not be edited. */
            ...
            Ext.Msg.alert('Feed no encontrado', 'Feed no encontrado!');
            ...
            if(feedRecord){
                ...
                //Otherwise the requested News is not available so...
                    ...
                    if(Ext.getStore('News').getCount() == 0){
                        ...
                        //Showing a warning message
                        Ext.Msg.alert('No se han encontrado noticias', 'No se han encontrado noticias!');
    ...
    saveFeed: function(){
        ...
        if(!errors.isValid()){
            ...
            Ext.Msg.alert('Guardar Feed', Ext.String.format('{0}', errors.first().getMessage()));
    ...
    deleteFeed: function(){
       ...
       Ext.Msg.confirm('Eliminar Feed', 'Confirma eliminar el  feed?', function(btn){
    ...
    onReadMore: function(){
        ...
        Ext.Msg.confirm('URL', 'Va a ser redireccionado a una URL EXTERNA.<br/>Continuar?', function(btn){
